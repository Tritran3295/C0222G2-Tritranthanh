...
<div class="container-fluid bg-success text-white" >
  <div class="col-12 row">
    <div class="col-1 "><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTJTZ2wGN_Zq-_nOaKIEVrRyl2GIbyyHVBLng&usqp=CAU" style="width:75px;" class="rounded-pill"></div>
    <div class="col-11 ">
  ...
  <div class="col-12 row ">
    <nav class="navbar">
      <div class="container-fluid text-white-50 bg-dark">
        ...
        <a class="navbar-brand" href="/family">Family</a>
