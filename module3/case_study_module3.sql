...
insert into vi_tri
value (1,'Quản lý',0),(2,'Nhân viên',0);
...
value (1,'Trung Cấp',0),(2,'Cao Đẳng',0),(3,'Đại Học',0),(4,'Sau Đại Học',0);
...
insert into bo_phan
value (1,'Sale-Marketing',0),(2,'Hành Chính',0),(3,'Phục vụ',0),(4,'Quản lý',0);
...
value (1,"Diamond",0),(2,"Platinum",0),(3,"Gold",0),(4,"Silver",0),(5,"Member",0);
...
insert into kieu_thue value (1,"year",0),(2,"month",0),(3,"day",0),(4,"hour",0);
create table loai_dich_vu(
ma_loai_dich_vu int primary key,
ten_loai_dich_vu varchar(45),
`status` bit default 0
);
insert into loai_dich_vu value (1,"Villa",0),(2,"House",0),(3,"Room",0);
...
insert into dich_vu_di_kem value(1,"Karaoke","10000","giờ","tiện nghi,hiện tại",0),
(2,"Thuê xe máy","10000","chiếc","hỏng 1 xe",0),(3,"Thuê xe đạp","20000","chiếc","tốt",0),
...
insert into dich_vu value (1,'Villa Beach Front',25000,10000000,10,'vip','Có hồ bơi',500,4,3,1,0),
	(2,'House Princess 01',	14000,5000000,7,'vip','Có thêm bếp nướng',null,3,2,2,0),
	(3,'Room Twin 01',5000,1000000,2,'normal','Có tivi',null,null,4,3,0),
	(4,'Villa No Beach Front',22000,9000000,8,'normal','Có hồ bơi',300,3,3,1,0),
	(5,'House Princess 02',10000,4000000,5,'normal','Có thêm bếp nướng',null,2,3,2,0),
	(6,'Room Twin 02',3000,900000,2,'normal','Có tivi',null,null,4,3,0);
insert into khach_hang value (1,'Nguyễn Thị Hào','1970-11-07',0,'643431213','0945423362','thihao07@gmail.com','23 Nguyễn Hoàng,Đà Nẵng',5,0),	
...
select hop_dong.ma_hop_dong,khach_hang.ma_khach_hang,khach_hang.ho_ten,loai_khach.ten_loai_khach,dich_vu.ten_dich_vu,
...
select month(hop_dong.ngay_lam_hop_dong),count(hop_dong.ma_khach_hang)  as 'so_luong_khach_hang'
from hop_dong
where year(hop_dong.ngay_lam_hop_dong)=2021
...
dich_vu.ma_dich_vu,sum(ifnull(hop_dong_chi_tiet.so_luong,0)) as 'so_luong_dich_vu_di_kem',hop_dong.tien_dat_coc
from hop_dong
...
select nhan_vien.ma_nhan_vien,nhan_vien.ho_ten,trinh_do.ten_trinh_do,bo_phan.ten_bo_phan,nhan_vien.so_dien_thoai,
nhan_vien.dia_chi
from nhan_vien
...
where year(hop_dong.ngay_ket_thuc) between 2020 and 2021 
group by nhan_vien.ma_nhan_vien,nhan_vien.ho_ten,trinh_do.ten_trinh_do,bo_phan.ten_bo_phan,nhan_vien.so_dien_thoai,
nhan_vien.dia_chi
