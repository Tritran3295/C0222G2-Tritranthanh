...
public class Facility {
    ...
    public Facility(int id, String nameFacility, Double area, Double cost, int maxPeople, String standardRoom, String descriptionConvenience, Double poolArea, int numberOfFloor, String facilityFree, int status, FacilityType facilityType, RentType rentType) {
        this.id = id;
